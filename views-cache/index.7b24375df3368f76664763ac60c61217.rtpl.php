				...
				<ul class="" id="bxslider-home4">
					<li>
						...
						<div class="caption-group">
							<h2 class="caption title" style="margin-top: -199px;">
								iPhone <span class="primary">6 <strong>Plus</strong></span>
							</h2>
							<h4 class="caption subtitle" style="margin-top: 1px;">Dual SIM</h4>
							<a class="caption button-radius" href="#" style="margin-top: 5px;"><span class="icon"></span>Comprar</a>
						</div>
					</li>
					<li><img src="/res/site/img/h4-slide2.png" alt="Slide">
						<div class="caption-group">
							<h2 class="caption title" style="margin-top: 99px;">
								by one, get one <span class="primary">50% <strong>off</strong></span>
							</h2>

							<h4 class="caption subtitle" style="margin-top: 2px;">school supplies & backpacks.*</h4>
							<a class="caption button-radius" href="#" style="margin-top: 5px;"><span class="icon"></span>Comprar</a>
						</div>
					</li>
					<li><img src="/res/site/img/h4-slide3.png" alt="Slide">
						<div class="caption-group">
							<h2 class="caption title" style="margin-top: 399px;">
								Apple <span class="primary">Store <strong>Ipod</strong></span>
							</h2>
							<h4 class="caption subtitle" style="margin-top: 2px;">Select Item</h4>
							<a class="caption button-radius" href="#" style="margin-top: 5px;"><span class="icon"></span>Comprar</a>
						</div>
					</li>
					<li><img src="/res/site/img/h4-slide4.png" alt="Slide">
						<div class="caption-group">
						  <h2 class="caption title" style="margin-top: 799px;">
								Apple <span class="primary">Store <strong>Ipod</strong></span>
							</h2>
							<h4 class="caption subtitle" style="margin-top: 1px;">& Phone</h4>
							<a class="caption button-radius" href="#" style="margin-top: 5px;"><span class="icon"></span>Comprar</a>
						</div>
					</li>
				</ul>
